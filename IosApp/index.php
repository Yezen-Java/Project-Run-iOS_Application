  ...
  <div class="topHeader">
	  ...
	  <div>
		  ...
		  <center>
			   ...
			   <button id="btnHomePage" onclick="show('Page1');"   class="btn btn-success" style="float: left;"><p class="HomePageText"><span class="glyphicon glyphicon-home"></span></p></button>
...
<!--==================================SECOND PAGE END ============================================--><!--======================================THIRD PAGE START =======================================-->
 <div id="Page3" class="page" style="display:none">
	 	  <center>
<center class="topHeader"><button id="btnGallery" onclick="show('Page2');" class="btn btn-success" style="float: left;"><span class="glyphicon glyphicon-arrow-left" ></span></button>
