...
<!--==================================SECOND PAGE END ============================================--><!--======================================THIRD PAGE START =======================================-->
 <div id="Page3" class="page" style="display:none">
	 	  <center>
<center class="topHeader"><button id="btnGallery" onclick="show('Page2');"  class="btn btn-default" style="float: left;"><span class="glyphicon glyphicon-arrow-left"></span></button>
